...
public class SWANExecute {
    public void SWAN_execute(LoadBean loadBean) throws IOException {
...
//        appendMethodB(temp+"/"+fileName,"R"+"\n");
        ...
        appendMethodB(temp+"/"+fileName,"myNorm=champ.norm(resultsDir=\""+loadBean.getResultsDir()+"\",method=\"SWAN\")\n");
...
//        String cmd1="\"F:\\Program Files\\R\\R-3.3.2\\bin\\R.exe\"  CMD BATCH --vanilla --slave"+" "+"\""+temp+"\\"+fileName+"\"";
        ...
        System.out.println("myNorm=champ.norm(resultsDir=\""+loadBean.getResultsDir()+"\",method=\"SWAN\")");
