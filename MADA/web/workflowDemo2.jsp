        ...
        <div id="side_right">
                ...
                <s:form action="customWorkflow_exe" id="customWorkflow_exe" enctype="multipart/form-data" method="post"
                    ...
                    <div class="blackdown_1">
                        <div class="file-box" style="display:block">
                            <input type='text' name='workflowCustom_zip' id="workflowCustom_zip" value="GSE100825.zip"
                    ...
                    <div class="blackdown_1">
                        <input type="radio" name="workflow_methValue" value="B" checked>B&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="workflow_methValue" value="M" >M
                    </div>
                    ...
                    <div class="blackdown_1">
                        <input type="radio" name="filterSNPs" value="TRUE" >TRUE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="filterSNPs" value="FALSE" checked>FALSE
                    </div>
                    ...
                    <div class="blackdown_1">
                        <input type="radio" name="filterCRO" value="TRUE" >TRUE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="filterCRO" value="FALSE" checked>FALSE
                    </div>
                    <!---------------------------------preprocess_tools---------------------------------------------------->
                    <div class="blacktop_1">
                        Preprocessing
                    ...
                    document.getElementById('workflowCustom_option_2').style.display='none';document.getElementById('workflowCustom_option_3').style.display='none';document.getElementById('workflowCustom_option_4').style.display='none';document.getElementById('workflowCustom_option_5').style.display='none';document.getElementById('workflowCustom_option_6').style.display='none';document.getElementById('workflowCustom_option_7').style.display='none';">BMIQ
                        ...
                        <!--FN-->
                        <input type="radio" name="workflowCustom_mapping" value="4" checked="true"
                        ...
                        <div class="workflowCustom_option1" id="workflowCustom_option_4" style="display:none">
                            --Choose microarray type is "450K" or "EPIC"<br>
                            <input type="radio" name="arraytype_fn" value="450K" >450K&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="arraytype_fn" value="EPIC" checked="true">EPIC<br>
                            --whether to set optional parameters?<br>
                            <input type="radio" name="workflowCustom_option_FN" value="1"
                                   onclick="document.getElementById('workflow_custom_fn').style.display='none'" checked="true">default&nbsp;&nbsp;&nbsp;
                        ...
                        <!--ill-->
                        <input type="radio" name="workflowCustom_mapping" value="5"
                    ...
                    <div class="blackdown_2_workflowCustom" style="overflow-y:scroll;">
                        ...
                        <input type="radio" name="workflowCustom_peak" value="1" checked="true"
                               onclick="document.getElementById('workflowCustom_option_limma').style.display='block';document.getElementById('workflowCustom_option_samr').style.display='none';
                        document.getElementById('workflowCustom_option_dmpFinder').style.display='none';document.getElementById('workflowCustom_option_samr').style.display='none';document.getElementById('workflowCustom_option_dmpFinder').style.display='none';document.getElementById('workflowCustom_option_dmrcate').style.display='none';document.getElementById('workflowCustom_option_bumphunter').style.display='none';document.getElementById('workflowCustom_option_lasso').style.display='none';document.getElementById('workflowCustom_option_seqlm').style.display='none';">Limma<a1>  Limma
                        calculates differential methylation probes between two phenotypes.</a1><br>
                        <div class="workflowCustom_option1" id="workflowCustom_option_limma" style="height:170px;display:none">
                            --Choose microarray type is "450K" or "EPIC"<br>
                            <input type="radio" name="arraytype_limma" value="450K" >450K&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="arraytype_limma" value="EPIC" checked="true">EPIC<br>
                            --whether to apply covariates to the design matrix?<br>
                            <input type="radio" name="workflowCustom_cor_limma" value="1"
                                   onclick="document.getElementById('workflow_cor_limma').style.display='none';" checked="true">False&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="workflowCustom_cor_limma" value="2"
                        ...
                        <div id="workflow_cor_limma" class="inputOption_setting" style="display:none">
                            <div id="cor1_option_center" class="inputOption_setting_center">
                                ...
                                <input type="text" class="input_setting_text" name="cor1" value="null"/><br><br>
            ...
            <div class="side_right" id="side_right_2" style="display:none">
                <div class="blackdown_tips" id="workflow_resultTips" style="display:none">
                    Your workflow has finished running,and we will send the results to your e-mail address as soon as
                    possible.
                    <br>
                    If you have questions about the results or if you want to get detail information about the finished
                    operation,please <a href="JavaScript:operation_detail();" style="text-decoration: none">click
                    here</a>
                </div>
                <div id="detail_out" class="inputOption_setting_de" style="display:none">
                    <div id="detail_in" class="inputOption_setting_center_de" style="overflow-y:scroll;">
                        ...
                        ${stdoutlist_peak}<br>
                        <input type="button" value="close" class="btn_cancel"
                               onclick="document.getElementById('detail_out').style.display='none'"/>
                    </div>
                </div>

                <div id="mapping_center1" class="visual_center" style="display:block">
                    <form action="visual_mapping_new" id="visual_mapping_new" enctype="multipart/form-data"
                          method="post"
                          onsubmit="return searchData('visual_mapping_new','btn_workflow_mapping','wait_workflow_mapping');">
                        <div class="blacktop_1">
                            Choose the type of your file
                            <div class="tip_out"><img class="tip" id="tip6" src="./img/tip.png"
                                                      onclick="JavaScript:Tip_click(6)"></div>
                        </div>
                        <div class="blackdown_1">
                            <input type="radio" name="mapping_radio" value="1" checked="true"
                                   onclick="document.getElementById('sample_mapping_generated').style.display='block';document.getElementById('sample_mapping_file').style.display='none';"/>Use
                            the newly generated file
                            <input type="radio" name="mapping_radio" value="2"
                                   onclick="document.getElementById('sample_mapping_generated').style.display='none';document.getElementById('sample_mapping_file').style.display='block';"/>Input
                            the file to view
                        </div>
                        <br>
                        <div id="sample_mapping_generated" style="display:block">
                            <div class="blackdown_2">
                                ...
                                <input type="text" name="workflowCustom_reference" value="${workflowCustom_reference}"
                                       style="display:none"/>
                                The path to save result:<br>
                                <h7>${workflowCustom_path}<br></h7>
                                <input type="text" name="workflowCustom_path" value="${workflowCustom_path}"
                                       style="display:none"/>
                            </div>
                            <div class="blacktop_1">
                                Input the scope of the gene
                                <div class="tip_out"><img class="tip" id="tip7" src="./img/tip.png"
                                                          onclick="JavaScript:Tip_click(7)"></div>
                                <s:fielderror fieldName="mapping_visual_scope"
                                              cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            </div>
                            <div class="blackdown_1">
                                <div class="file-box" id="file-box_mapping_visual_scope" style="display:block">
                                    <input type='text' name='mapping_visual_scope' id="mapping_visual_scope"
                                           value="${Scope_demo}" class='input_text'
                                           onBlur="ValidateChar(this.value,'mapping_visual_scope')"/>
                                </div>
                            </div>
                        </div>

                        <div class="blackdown_3" id="sample_mapping_file" style="display:none">
                            The path of the sam file: <s:fielderror fieldName="mapping_sam"
                                                                    cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='mapping_sam' id="mapping_sam" class='input_text'
                                       onBlur="ValidateChar(this.value,'mapping_sam')"/>
                                <input type='button' class='btn' value='Choose File'/>
                                <input type="file" name="fileField_mapping" class="fileField"
                                       onchange="return (fileChange(this,'mapping_sam' )&& checkFileExt(this.value,'mapping_sam'))"/>
                            </div>
                            The path of the reference file: <s:fielderror fieldName="mapping_reference"
                                                                          cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='mapping_reference' id="mapping_reference" class='input_text'
                                       onBlur="ValidateChar(this.value,'mapping_reference')"/>
                                <input type='button' class='btn' value='Choose File'/>
                                <input type="file" name="fileField_mapping" class="fileField"
                                       onchange="return (fileChange(this,'mapping_reference' )&& checkFileExt(this.value,'mapping_reference'))"/>
                            </div>
                            the scope of gene: <s:fielderror fieldName="mapping_scope"
                                                             cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='mapping_scope' id="mapping_scope" class='input_text'
                                       onBlur="ValidateChar(this.value,'mapping_scope')"/>
                            </div>
                        </div>
            ...
            <div class="side_right" id="side_right_3" style="display:none">
                <div id="peakcalling_center" class="visual_center" style="display:block">
                    <form action="peakcalling_visual_new" id="peakcalling_visual_new" enctype="multipart/form-data"
                          method="post"
                          onsubmit="return searchData('peakcalling_visual_new','btn_workflow_peak','wait_workflow_peak');">
                        <div class="blacktop_1">
                            Choose the type of your file
                            <div class="tip_out"><img class="tip" id="tip8" src="./img/tip.png"
                                                      onclick="JavaScript:Tip_click(8)"></div>
                        </div>
                        <div class="blackdown_1">
                            <input type="radio" name="peakcalling_type" value="1" checked="true"
                                   onclick="document.getElementById('sample_peakcalling').style.display='block';document.getElementById('sample_center').style.display='none';"/>Use
                            the newly generated file
                            <input type="radio" name="peakcalling_type" value="2"
                                   onclick="document.getElementById('sample_peakcalling').style.display='none';document.getElementById('sample_center').style.display='block';"/>Input
                            the file to view
                        </div>
                        <br>
                        <div id="sample_peakcalling" style="display:block">
                            <div class="blackdown_2">
                                ...
                                <input type="text" name="bampath_treatment" value="${bampath_treatment}"
                                       style="display:none"/>
                                The path of the control file:<br>
                                <h7>${bampath_control}<br></h7>
                                <input type="text" name="bampath_control" value="${bampath_control}"
                                       style="display:none"/>
                            ...
                            <div class="blacktop_1">
                                Input the scope of the gene
                                <div class="tip_out"><img class="tip" id="tip9" src="./img/tip.png"
                                                          onclick="JavaScript:Tip_click(9)"></div>
                                <s:fielderror fieldName="peakcalling_visual_scope"
                                              cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            </div>
                            <div class="blackdown_1">
                                <div class="file-box" style="display:block">
                                    <input type='text' name='peakcalling_visual_scope' id="peakcalling_visual_scope"
                                           value="${Scope_demo}" class='input_text'
                                           onBlur="ValidateChar(this.value,'peakcalling_visual_scope')"/>
                                </div>
                            </div>
                        </div>

                        <div class="blackdown_3" id="sample_center" style="display:none">
                            The path of the treatment file: <s:fielderror fieldName="peakcalling_treatment"
                                                                          cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='peakcalling_treatment' id="peakcalling_treatment"
                                       class='input_text' onBlur="ValidateChar(this.value,'peakcalling_treatment')"/>
                                <input type='button' class='btn' value='Choose File'/>
                                <input type="file" name="fileField_peak" class="fileField"
                                       onchange="return (fileChange(this,'peakcalling_treatment' )&& checkFileExt(this.value,'peakcalling_treatment'))"/>
                            </div>
                            The path of the control file:<s:fielderror fieldName="peakcalling_control"
                                                                       cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='peakcalling_control' id="peakcalling_control"
                                       class='input_text' onBlur="ValidateChar(this.value,'peakcalling_control')"/>
                                <input type='button' class='btn' value='Choose File'/>
                                <input type="file" name="fileField_peak" class="fileField"
                                       onchange="return (fileChange(this,'peakcalling_control' )&& checkFileExt(this.value,'peakcalling_control'))"/>
                            </div>
                            The path of the peak file:<s:fielderror fieldName="peakcalling_peak"
                                                                    cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='peakcalling_peak' id="peakcalling_peak" class='input_text'
                                       onBlur="ValidateChar(this.value,'peakcalling_peak')"/>
                                <input type='button' class='btn' value='Choose File'/>
                                <input type="file" name="fileField_peak" class="fileField"
                                       onchange="return (fileChange(this,'peakcalling_peak' )&& checkFileExt(this.value,'peakcalling_peak'))"/>
                            </div>
                            The path of the reference file:<s:fielderror fieldName="peakcalling_refer"
                                                                         cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='peakcalling_refer' id="peakcalling_refer" class='input_text'
                                       onBlur="ValidateChar(this.value,'peakcalling_refer')"/>
                                <input type='button' class='btn' value='Choose File'/>
                                <input type="file" name="fileField_peak" class="fileField"
                                       onchange="return (fileChange(this,'peakcalling_refer' )&& checkFileExt(this.value,'peakcalling_refer'))"/>
                            </div>
                            the scope of gene:<s:fielderror fieldName="peakcalling_scope"
                                                            cssStyle="color:#57779e;float:right;margin-top:0px;margin-right:10px;"/>
                            <div class="file-box1" style="display:block">
                                <input type='text' name='peakcalling_scope' id="peakcalling_scope" class='input_text'
                                       onBlur="ValidateChar(this.value,'peakcalling_scope')"/>
                            </div>
